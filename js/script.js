...
//////// print quote function //////////
    ...
    function printQuote(){                                                   // the function printQuote will do the function of printing the quotes, there is nothing on the () becasue we only have 1 global entry and you can call it in in the function.
      ...
      var message =  "";                                                     // this is not need and the page will website will work.
        ...
        if (randomQuote.citation !="undefined") {                             // the IF statement works (if) one of the properties does not work, this will allow to keep running the quote
            message += "<span class = 'citation'>" + randomQuote.citation + "</span>";
          }
        if (randomQuote.year !="undefined") {                                 // same as the other one up top
            message += "<span class = 'year'>" + randomQuote.year + "</span>";
          } 
        if (randomQuote.tags !="undefined") {                                 // same as the other one up top
          ...
          document.getElementById("quote-box").innerHTML = message;
                                                                              // this allows javascript to go inside HTML to input the information or source 
          }
        printQuote();
